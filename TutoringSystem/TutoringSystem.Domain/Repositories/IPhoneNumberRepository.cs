...
namespace TutoringSystem.Domain.Repositories
{
    public interface IPhoneNumberRepository
    {
        ...
        Task<PhoneNumber> GetPhoneNumberAsync(Expression<Func<PhoneNumber, bool>> expression, bool? isActiv = true);
        Task<IEnumerable<PhoneNumber>> GetPhoneNumbersCollectionAsync(Expression<Func<PhoneNumber, bool>> expression, bool? isActiv = true);
    }
}
