...
namespace TutoringSystem.Infrastructure.Data.Migrations
{
    ...
    [Migration("20210821203010_AdditionalOrderStatus")]
    partial class AdditionalOrderStatus
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("TutoringSystem.Domain.Entities.Lesson", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint")
            ...
            modelBuilder.Entity("TutoringSystem.Domain.Entities.School", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint")
            ...
            modelBuilder.Entity("TutoringSystem.Domain.Entities.Lesson", b =>
                {
                    b.HasOne("TutoringSystem.Domain.Entities.Reservation", "Reservation")
                        .WithOne("Lesson")
                        .HasForeignKey("TutoringSystem.Domain.Entities.Lesson", "ReservationId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
            ...
            modelBuilder.Entity("TutoringSystem.Domain.Entities.School", b =>
                {
                    b.HasOne("TutoringSystem.Domain.Entities.Student", "Student")
                        .WithOne("School")
                        .HasForeignKey("TutoringSystem.Domain.Entities.School", "StudentId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
